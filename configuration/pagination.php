...
function paginate($url, $link, $total, $current, $adj=3) {
    ...
    if ($total > 1) {
        ...
        $pagination .= "<div class=\"pagination pagination-custom\"><ul>\n";
        ...
        if ($current == 2) {
            ...
            $pagination .= "<li><a href=\"{$url}\"><i class=\"icon-double-angle-left\"></i></a></li>";
        } elseif ($current > 2) {
            // la page courante est supérieure à 2, le bouton renvoie sur la page dont le numéro est immédiatement inférieur
            $pagination .= "<li><a href=\"{$url}{$link}{$prev}\"><i class=\"icon-double-angle-left\"></i></a></li>";
        } else {
        ...
        if ($total < 7 + ($adj * 2)) {
            ...
            $pagination .= ($current == 1) ? "<li><a href=\"{$url}\">1</a></li>" : "<li><a href=\"{$url}\">1</a></li>"; // Opérateur ternaire : (condition) ? 'valeur si vrai' : 'valeur si fausse'
         ...
         * ========================================= */
            ...
            if ($current < 2 + ($adj * 2)) {
                ...
                $pagination .= ($current == 1) ? "<li><a href=\"{$url}\">1</a></li>" : "<li><a href=\"{$url}\">1</a></li>";
         ...
         * =============================== */
        if ($current == $total)
            $pagination .= "<li><a href=\"\"><i class=\"icon-double-angle-right\"></i></a></li>\n";
        else
            $pagination .= "<li><a href=\"{$url}{$link}{$next}\"><i class=\"icon-double-angle-right\"></i></a></li>\n";
